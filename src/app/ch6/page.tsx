...
const Ch6 = () => {
  return (
    <div>
        ...
        <section className='bg-teal-900 py-8'>
            ...
            <div className='flex gap-6'>
                <div className='flex-1 text-white'>
                    ...
                    <button className='px-4 py-2 bg-sky-500 rounded-full uppercase mt-4 font-semibold text-black'>i want to learn</button>
                </div>
            ...
            <div className='w-[80%] mx-auto'>
                ...
                <div className='flex gap-6'>
                    <div className='flex-initial w-3/4'>
                        <h2 className='text-teal-800 text-3xl font-semibold mb-6'>Quality design Lorem ipsum dolor sit.</h2>
                    ...
                    <div className='flex-initial w-1/4 bg-teal-900 text-white p-4 text-center'>
                        <div className='mb-4'>
